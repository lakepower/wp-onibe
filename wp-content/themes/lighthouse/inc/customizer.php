...
function lighthouse_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			...
			<a class="button button-primary" href="https://lighthouseseooptimization.github.io/wordpress/lighthouse/" target="_blank">Upgrade now!</a>
			',
			)
		);  
